	...
	<table class="table table-hover table-striped">
		...
		@foreach ($posts as $post)
		    <tr>
			    ...
			    <td style="text-align: center">{{ $post->user->email}}</td>
...
<div class="container">
	{{ Form::model($post, array('action' => array('PostsController@index'), 'method' => 'GET')) }}
	...
	@endif
		{{Form::text('searchTitle', null, array('class' => 'form-group form-control'))}}
		{{Form::Submit('Search', array('class' => 'btn btn-default form-group', 'id' => 'submit'))}}
	{{Form::close()}}
</div>
@stop
